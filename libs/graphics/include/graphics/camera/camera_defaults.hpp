...
namespace graphics::camera
{
	...
	struct Defaults
	{
        ...
        static constexpr    glm::vec3               rot         { 0.F, 0.F, 0.F };
        static constexpr    glm::vec3               scl         { 1.F, 1.F, 1.F };
        inline static const components::Transform   transform   { pos, rot, scl };

        /*----------*/
        /* Matrices */
        /*----------*/
        inline static const glm::mat4 view{ 1.F };
        inline static const glm::mat4 proj{ 1.F };
